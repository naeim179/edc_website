  ...
  return (
    <div className="flex items-center justify-between p-3 bg-white rounded-2xl border border-slate-100 shadow-sm gap-4">
      ...
      <div className="flex flex-col items-end justify-between h-full py-1 shrink-0">
        <span className="text-xs font-bold text-slate-500">مكتمل {progress}%</span>
        <button className="px-3 py-1.5 text-xs font-bold text-[#087a54] border border-[#087a54]/30 rounded-lg hover:bg-[#087a54] hover:text-white transition-all">
          متابعة الدرس
        </button>
      </div>
    </div>
