      ...
      >
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-11 pr-11 pl-4 bg-white text-slate-700 text-[14px] rounded-[14px] border border-slate-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#087a54]/20 text-right"
          />
