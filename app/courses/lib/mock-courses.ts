...
export const courses: Course[] = [
  {
    ...
    description: "دورة شاملة تغطي أساسيات الأمن السيبراني، من حماية الشبكات إلى اختبار الاختراق الأخلاقي، مع تطبيقات عملية على أدوات حقيقية.",
  },
  {
    id: 2,
    ...
    description: "تعلم مفاهيم الشبكات من الصفر: بروتوكولات TCP/IP، الراوترات، والسويتشات، مع أمثلة تطبيقية.",
  },
  {
    id: 3,
    ...
    description: "استكشف أساسيات الذكاء الاصطناعي وتعلم الآلة، وابنِ أول نموذج تنبؤي بسيط باستخدام بايثون.",
  },
];